# Common Threat Matrix for Kubernetes (K8s) Cluster
...
I have used MITRE framework to create a threat matrix specific to K8s cluster


# Common Threat Matrix for CI/CD Pipeline
This is an ATT&CK-like matrix focus on K8s cluster specific risk.  
...
- [Components of K8s cluster](#components-of-K8s-cluster)
